...
1. 🟡 **מחיקת 72 תזכורות-2049 - ממתינה לאמיר.** התשתית מוכנה ופרוסה (ראה סעיף תזכורות-השירות
   למעלה). הסדר שה-spec קובע: להגדיר ביטוח כחשבון שנתי בכל נכס רלוונטי עם תאריך החידוש האמיתי,
   לאמת שתזכורת החידוש הבאה מופיעה נכון, **ורק אז** למחוק. המחיקה טעונה אישור מפורש בעת הביצוע.
2. 🔵 **טרם אופיין: "עזיבה ופינוי".** הפער שזוהה - `early_term_protection` **יחסום ביטול-חוזה
