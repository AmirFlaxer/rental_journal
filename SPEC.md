...
- **אימות ויזואלי חי: ממתין לאמיר** (רענון הדשבורד). מקומית לא היה session מחובר, והטלפון
  לא היה מחובר ל-adb.
- **נמצא ולא תוקן: מסך "ייבוא חוזה" מסיים חוזה פעיל גם כשהחוזה המיובא עתידי.** ר' TODO.
