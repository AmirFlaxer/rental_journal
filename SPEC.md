...
1. 🟡 **spec כתוב ומאושר שטרם מומש:** `docs/superpowers/specs/2026-07-26-utility-reminders-design.md`
   (ביטוח שנתי · אחריות-לפי-אכלוס · אופק מתגלגל). זה מה שיאפשר למחוק סוף-סוף את 72 תזכורות-2049.
